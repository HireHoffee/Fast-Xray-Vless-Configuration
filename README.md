...
**P.S. Скрипты, которые используются далее могут меняться на более актуальные, можете посмотреть их в этом [репозитории](https://github.com/xVRVx/autoXRAY)**
